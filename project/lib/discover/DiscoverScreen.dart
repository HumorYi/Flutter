...
class _DiscoverScreenState extends State<DiscoverScreen> {
  ...
  void initState() {
    ...
    // getCompanyList();
    // getCompanyList1();
    getCompanyList2(false);

    _scrollController.addListener(() {
      final position = _scrollController.position;
      // 滚动偏移量达到最大滚动范围才触发 下拉加载
  ...
  getCompanyList() {
    ...
    setState(() {
      _companies = Company.jsonToListByLocal("""{
        "list": [
          {
            "logo": "https://img.bosszhipin.com/beijin/mcs/chatphoto/20161230/b0df9f099f1d6db1937bc78068fb4c15760bb3f59f760cd45f5945e615392f6f.jpg",
            "name": "杭州蚂蚁金服信息技术有限公司",
  ...
  getCompanyList2(bool more) async {
    // http 基于对 HttpClient 的一层封装，使用更方便
    String url = 'http://m.app.haosou.com/index/getData?type=1&page=$page';
    var response = await http.get(url);
    var map = jsonDecode(response.body);

    setState(() {
      var list = Company.mapToList(map);
